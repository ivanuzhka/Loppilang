...
void FuncTID::insert(std::string name, std::string return_type, func_parameters params)
{
...
void TypeTID::insert(std::string name, std::map<std::string, std::string> fields)
{
